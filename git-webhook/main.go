...
import (
	...
	"github.com/presslabs/stack/git-webhook/pkg/controller"
...
func main() {
	...
	entryLog.Info("setting up git webhook controller")
	if err := controller.Add(mgr); err != nil {
		entryLog.Error(err, "unable to set git webhook controller")
		os.Exit(1)
	}
